...
if( ! class_exists('gag_cookieconsent') ):
    class gag_cookieconsent
    {
        ...
        public static function scripts_and_css()
        {
            ...
            if( self::$settings['cc-revocable-cookie-notice'] ) {
                $revokable = true;
                $revokeBtn = '<div class="cc-revoke {{classes}}">'.self::$settings['cc-revocable-button-text'].'</div>';
            } else {
                $revokable = false;
                $revokeBtn = '<div class="" style="display: none !important;"></div>';
            }
