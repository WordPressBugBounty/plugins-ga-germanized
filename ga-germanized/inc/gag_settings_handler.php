	...
	class gag_settings_handler
	{
		...
		public static function settings()
		{
			return array(
                ...
                'cc-revocable-cookie-notice' => array(
                    'name'      => 'cc-revocable-cookie-notice',
                    'default'   => 1,
                    'required'  => false,
                    'min_l'     => 0,
                    'max_l'     => 1,
                ...
                'cc-revocable-button-text' => array(
                    'name'      => 'cc-revocable-button-text',
                    'default'   => __('Cookie Policy', 'ga-germanized'),
                    'required'  => false,
                    'min_l'     => 0,
                    'max_l'     => 65
                ),
		...
		public static function save_settings( WP_REST_Request $request )
		{
			...
			foreach ($settings as $setting) {
				...
				} elseif( $setting['default'] === 1 || $setting['default'] === 0 ) {
				    $value = 0;
                } else {
					$value = null;
				}
		...
		public static function current_settings()
		{
			...
			foreach ($settings as $setting) {
				...
				if( ! is_bool($current_settings[ $setting_name ]) && ! is_numeric($current_settings[ $setting_name ]) && $current_settings[ $setting_name ] !== 0 && empty($current_settings[ $setting_name ]) ) {
