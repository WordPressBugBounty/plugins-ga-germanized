<div class="wrap">
	...
	<div class="google-analytics-germanized">
		<h1><span class="dashicons dashicons-chart-area"></span> <?php esc_html_e('Analytics Germanized for Google Analytics', 'ga-germanized') ?></h1>
		...
		<form action="<?php echo esc_url( rest_url( gag_settings_handler::$namespace . '/' . gag_settings_handler::$version . '/save-settings') ) ?>" class="google-analytics-germanized-form" id="google-analytics-germanized-form" novalidate>
			...
			<nav class="gag-settings-buttons">
				<ul>
					...
					<li><a href="#tab6"><?php esc_html_e('About us', 'ga-germanized') ?><span class="new"><?php esc_html_e('NEW', 'ga-germanized') ?></span></a></li>
				</ul>
			</nav>
            ...
            <div class="gag-settings-wrapper-outer">
                ...
                <div class="gag-settings-wrapper tab-item" id="tab3" style="display: none;">
                    ...
                    <div class="gag-settings-item clear" id="revocable-cookie-notice-wrapper">

                        <div class="oneline_field checkboxarea clear">
                            <div class="leftbox">
                                <strong><?php esc_html_e('Revocable', 'ga-germanized') ?></strong>
                            </div>

                            <div class="rightbox">
                                <input type="checkbox" name="cc-revocable-cookie-notice" id="cc-revocable-cookie-notice" value="1" <?php checked(1, (int) $settings['cc-revocable-cookie-notice']) ?> />

                                <label for="cc-revocable-cookie-notice" class="checkboxlabel"><?php esc_html_e('Revocable Cookie Notice', 'ga-germanized') ?></label>
                                <p class="mini-description"><?php esc_html_e('Cookie Notice could be opened again with a small grey button.', 'ga-germanized') ?></p>
                            </div>
                        </div>

                        <div class="oneline_field clear">
                            <div class="leftbox">
                                <label for="cc-revocable-button-text"><?php esc_html_e('Button Text', 'ga-germanized') ?></label>
                            </div>

                            <div class="rightbox">
                                <input type="text" name="cc-revocable-button-text" id="cc-revocable-button-text" placeholder="<?php esc_attr_e('Cookie Policy', 'ga-germanized') ?>" value="<?php echo esc_attr( $settings['cc-revocable-button-text'] ) ?>" />
                            </div>
                        </div>
                    ...
                    <div class="gag-settings-item clear">
                        ...
                        <div class="oneline_field clear" id="dismiss-button-wrapper">
                            <div class="leftbox">
                ...
                <div class="gag-settings-wrapper tab-item" id="tab5" style="display: none;">
                    ...
                    <div class="gag-analytics-id gag-settings-item ">
                        ...
                        <p style="text-align: center"><iframe width="560" height="315" src="https://www.youtube-nocookie.com/embed/rP_4ak9bCRs" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></p>
                    ...
                    <div class="gag-settings-item onegagbox">
                        ...
                        <p>Der an dieser Stelle bisher erwähnte Vertrag ist von Google digitalisiert worden. So kann der Vertrag zur Datenverarbeitung digital in Analytics geschlossen werden, ebenso wie der Zusatz zur Datenverarbeitung in Punkt 2.</p>
                        <p>Details sind hier zu finden: <a href="https://support.google.com/analytics/answer/3379636" target="_blank">Google Analytics Datenverarbeitungsbedingungen</a></p>

                        <p>Konkret schreibt Google dazu (<a href="https://static.googleusercontent.com/media/www.google.com/de//analytics/terms/de.pdf" target="_blank">Quelle</a>):</p>
                        <p>Bitte beachten Sie, dass der bisher an dieser Stelle verfügbare Vertrag zur Auftragsdatenverarbeitung nach § 11 BDSG (1990) mit Geltung der EU Datenschutzgrundverordnung 2016/679 (DSGVO) seit dem 25. Mai 2018 nicht mehr zur Verfügung steht.</p>
                        <p>Stattdessen steht ab diesem Zeitpunkt ein Auftragsverarbeitungsvertrag nach Artikel 28 DSGVO zur Verfügung, den Sie elektronisch abschließen können (vgl. Sie bitte Art. 28 Abs. 9 DSGVO zur Möglichkeit, Auftragsverarbeitungsverträge auch in ‘elektronischer Form’ abzufassen).</p>
                        <p>Weitere Informationen zum Auftragsverarbeitungsvertrag für Google Analytics finden Sie <a href="https://support.google.com/analytics/answer/3379636" target="_blank">hier</a></p>
                    </div>
    ...
    <p class="ga-copyright"><?php echo sprintf( esc_html__('developed and maintained by %s.'), '<a href="https://www.bajorat-media.com/">'.esc_html__('Bajorat Media - WordPress Agency').'</a>' ) ?></p>

    <p class="ga-copyright"><a href="https://www.bajorat-media.com/" target="_blank"><img src="<?php echo plugins_url(dirname(PBGAG_BASE)) ?>/assets/img/bajorat-media.png" width="250" height="59" alt="Bajorat Media" /></a></p>
