	...
	class gaGermanized
	{
		public static function init()
		{
			...
			if( is_admin() ) {
				...
				try {
                    new pbcockpitnotice([
                        'logo'              => plugins_url(dirname(PBGAG_BASE)).'/assets/img/bajorat-media-white.svg',
                        'link_de'           => 'https://cockpit.bajorat-media.com/infos/?utm_source=ga-germanized&utm_medium=banner&utm_campaign=ga-germanized',
                        'link_en'           => 'https://cockpit.bajorat-media.com/en/infos/?utm_source=ga-germanized&utm_medium=banner&utm_campaign=ga-germanized',
                        'only_on_screens'   => true,
                        'allowed_screens'   => array('settings_page_ga-germanized')
                    ]);
                } catch (Exception $e) {}
